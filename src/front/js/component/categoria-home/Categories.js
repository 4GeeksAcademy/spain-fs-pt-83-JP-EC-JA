    ...
    <div className="py-5 text-center categoria">
      <div className="container-fluid">
        ...
        <div className="row justify-content-center row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-md-4">
          ...
          <div className="col">
            <img src={electronics} />
            <h5 className="text-uppercase mt-5"><Link to={'/'} className="btn btn-outline-dark px-5 rounded-0">electronics</Link></h5>

          </div>

          <div className="col">
            <img src={jewelery} />
            <h5 className="text-uppercase mt-5"><Link to={'/'} className="btn btn-outline-dark px-5 rounded-0">jewelery</Link></h5>

          </div>

          <div className="col">
            <img src={men} />
            <h5 className="text-uppercase mt-5"><Link to={'/'} className="btn btn-outline-dark px-5 rounded-0">men's clothing </Link></h5>
          </div>

          <div className="col">
            <img src={women} />
            <h5 className="text-uppercase mt-5"><Link to={'/'} className="btn btn-outline-dark px-5 rounded-0">women's clothing</Link></h5>
          </div>
        </div>
      </div>
